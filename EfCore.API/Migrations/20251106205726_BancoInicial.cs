    ...
    public partial class BancoInicial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EndrecosEntrega", x => x.Id);
                    table.ForeignKey(
                        name: "FK_EndrecosEntrega_Usuarios_UsuarioId",
                        column: x => x.UsuarioId,
                        principalTable: "Usuarios",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EndrecosEntrega_UsuarioId",
                table: "EndrecosEntrega",
                column: "UsuarioId");
        }
